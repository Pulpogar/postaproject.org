				...
				<div class="d-flex justify-content-center">
					<nav id="nav-menu-container" class="shift">
						<ul class="nav-menu">
							...
							<li class="menu-has-children"><a href="projects.php"><p style="font-size: 18px"><i class="ti-clipboard"></i>&nbsp&nbsp<?php echo $txtproyectos; ?>&nbsp<i class="ti-angle-down"></i></p></a>
							<ul>
								...
								<li><a href="edit.php"><i class="ti-eye"></i> Editar un proyecto</a></li> -->
