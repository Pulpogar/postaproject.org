<div class="modal fade" id="edit_<?php echo $idioma['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="input-group mb-2">
              ...
              value="<?php echo utf8_encode(utf8_decode($idioma['es'])) ?>">
            </div>
                <div class="input-group mb-2">
                  <div class="input-group-prepend">
                  ...
                  <input type="text" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default"
                  value="<?php echo utf8_encode(utf8_decode($idioma['it'])) ?>">
                </div>
                ...
                <div class="input-group mb-2">
                  ...
                  <input type="text" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default"
                  value="<?php echo utf8_encode(utf8_decode($idioma['en'])) ?>">
                </div>
                ...
                <div class="input-group mb-2">
                  ...
                  <input type="text" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default"
                  value="<?php echo utf8_encode(utf8_decode($idioma['br'])) ?>">
                </div>
<br>
                <div class="input-group mb-2">
                  <div class="input-group-prepend">
  ...
  <?php
      ...
      <div class="modal fade" id="addLanguage">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title"><i class="fas fa-plus"></i>&nbsp;<?php echo $txtAgregarIdioma;?></h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>            
