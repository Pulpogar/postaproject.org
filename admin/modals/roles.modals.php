<div class="modal fade" id="edit_<?php echo $rol['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="input-group mb-2">
              ...
              value="<?php echo utf8_encode(utf8_decode($rol['es'])) ?>">
            </div>
                <div class="input-group mb-2">
                  <div class="input-group-prepend">
                  ...
                  <input type="text" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default"
                  value="<?php echo utf8_encode(utf8_decode($rol['it'])) ?>">
                </div>
                ...
                <div class="input-group mb-2">
                  ...
                  <input type="text" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default"
                  value="<?php echo utf8_encode(utf8_decode($rol['en'])) ?>">
                </div>
                ...
                <div class="input-group mb-2">
                  ...
                  <input type="text" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default"
                  value="<?php echo utf8_encode(utf8_decode($rol['br'])) ?>">
                </div>
<br>
                <div class="input-group mb-2">
                  <div class="input-group-prepend">
      ...
      <div class="modal fade" id="addRol">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form name="paymentitrform" id="paymentitrform" class="payment" method="post" action="abc.php">          
            <div class="modal-body">
            <div class="input-group mb-2">
              <div class="input-group-prepend">
                <span class="input-group-text" id="inputGroup-sizing-default"><?php echo $txtIdiomaEnIdioma;?>&nbsp;<span class="flag-icon flag-icon-es"></span></span>
            ...
            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-default" data-dismiss="modal">&nbsp;<?php echo $btnCerrar;?></button>
              <button type="submit" class="btn btn-primary">&nbsp;<?php echo $btnGuardarCambios;?></button>
            </div>
          </div>
        </div>
      </div>
...
<script>
    $(function(){
       $('addRol').on('submit', function(e){
            e.preventDefault();
            $.ajax({
                url: "add-rol.php",
                type: "POST",
                data: $("addRol").serialize(),
